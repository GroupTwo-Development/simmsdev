            ...
            @if (has_nav_menu('primarp_page_nav'))
                <div class="primary-page-main-nav mt-5 lg:mt-8 mb-5" aria-label="{{ wp_get_nav_menu_name('primarp_page_nav') }}">
                    {!! wp_nav_menu([
                        ...
                        'menu_class' => 'primary-page-nav primary-search-page text-lg flex flex-row uppercase justify-between items-center space-x-1  relative capitalize tracking-[0.45px]',
