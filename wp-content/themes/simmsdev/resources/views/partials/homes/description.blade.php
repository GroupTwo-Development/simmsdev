       ...
       <div class="bg-primary-green relative pt-14 xl:pt-20 pb-28 lg:pb-40 overflow-hidden">
            <div class="container mx-auto">
                <div class="text-white text-center xl:max-w-screen-lg mx-auto">
                    @if ($homes_items['headline'])
                        <h2 class="font-arno_pro_subhead font-normal text-3xl md:text-4xl mb-5">{{ $homes_items['headline'] }}</h2>
                    @endif
                    @if ($homes_items['description'])
                        <div>
                            {!! $homes_items['description'] !!}
                        </div>
                    @endif
                </div>
            </div>
