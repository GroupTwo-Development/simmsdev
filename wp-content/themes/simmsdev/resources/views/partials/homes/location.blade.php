@if ($homes_items['location'])
    <section id="location">
        ...
        <div class="lg:flex lg:flex-row lg:justify-between w-full">
            ...
            @if ($homes_items['location'])
                <div class="lg:w-1/2 lg:h-full">
                    <div class="acf-map" data-zoom="16">
                        <div class="marker" data-lat="{{$homes_items['location']['latitude']}}" data-lng="{{$homes_items['location']['longitude']}}"></div>
                      </div>
                </div>
            @endif
            ...
            {{-- content-right --}}
            <div class="lg:w-1/2">
                <div class="relative object-cover w-full bg-primary-green insert lg:h-[517px]" style="background-image: url('@asset('assets/pattern3.png')')">
                    <div class="container mx-auto">
                        <div class="py-10 sm:py-12 lg:pl-10">
                            ...
                            <span class="text-sm font-[500] text-white">{{ $homes_items['city'] . ', ' . $homes_items['state'] }}</span>
