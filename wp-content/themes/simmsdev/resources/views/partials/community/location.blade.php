@if ($communities_items['location'])
    <section id="location">
        ...
        <div class="lg:flex lg:flex-row lg:justify-between w-full">
            ...
            {{-- content-right --}}
            <div class="lg:w-1/2">
                <div class="relative object-cover w-full lg:min-h-[517px] bg-primary-green insert flex flex-col justify-center h-full" style="background-image: url('@asset('assets/pattern3.png')')">
                    <div>
                        <div class="container mx-auto">
                            <div class="py-10 sm:py-12 lg:pl-10">
                                ...
                                <x-contact-form-modal class="bg-transparent border-[2px] text-base border-white py-2 hover:border-simms-gold hover:text-black hover:bg-simms-gold transition duration-75 ease-in-out text-white">
