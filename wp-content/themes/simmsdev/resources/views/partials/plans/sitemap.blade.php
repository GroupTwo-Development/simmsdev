                 ...
                 <div class="md:max-w-screen-md lg:max-w-screen-md mx-auto">
                    <div class="py-3 group lg:flex lg:flex-row lg:justify-between w-full lg:space-x-6">
                      ...
                      @if ($plans_items['interactive_plan'])
                        <x-cta-link href="{{ $plans_items['interactive_plan'] }}" class="text-secondary-green border-b-secondary-green mt-3 md:mt-5 hover:text-simms-gold transition-all ease-in-out">{{ __('View Interactive Plans') }}
                        </x-cta-link>
                      @endif
                  </div>
              </div>
