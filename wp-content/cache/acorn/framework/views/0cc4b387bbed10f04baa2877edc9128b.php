<div  class="relative">
    ...
    <button type="button" data-fancybox data-src="#dialog-content" class="bg-simms-gold uppercase font-[500] tracking-[0.1em] text-center text-black inline-block px-4 py-3 whitespace-nowrap hover:bg-white transition-all ease-in-out">
        Get Started
    </button>
