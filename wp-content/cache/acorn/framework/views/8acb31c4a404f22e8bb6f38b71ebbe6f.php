                ...
                <h2 class="font-arno_pro_subhead font-normal text-3xl md:text-4xl lg:text-5xl mb-3 lg:mb-5">Floor Plan</h2>
                 ...
                 <div class="md:max-w-screen-md lg:max-w-screen-md mx-auto">
                    <div class="py-3 group lg:flex lg:flex-row lg:justify-between w-full lg:space-x-6">
                        <?php $__currentLoopData = $homes_items['sitemap']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sitemap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <?php if($homes_items['interactive_plan']): ?>
...
<?php endif; ?>
<?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/partials/homes/sitemap.blade.php ENDPATH**/ ?>