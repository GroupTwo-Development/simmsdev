<article class="group flex max-w-sm flex-col overflow-hidden bg-white shadow-md mb-8">
    <div class="h-56 md:h-56 overflow-hidden relative"> 
    ...
    <div class="flex flex-col gap-4">
        ...
        <?php if($floorplan_item['min_beds'] || $floorplan_item['min_bath'] || $communities_items['min_sqft'] || $floorplan_item['baths']): ?>
            <div class="border-b-[1px] border-simms-gold">
                <div class="px-3 pb-3 flex flex-row justify-between items-center content-center gap-1">
                    <?php if($floorplan_item['min_beds']): ?>
                    ...
                    <?php endif; ?>
                    <?php if($floorplan_item['min_bath'] && $floorplan_item['max_bath']): ?>
                        <div class="flex flex-row sm:flex-col md:flex-row lg:flex-col xl:flex-row  gap-2 items-center content-center">
                            <img class="bg-cover object-cover" src="<?= \Roots\asset('images/bathroom-icon.png'); ?> " /> 
                            <div>
                                <span class="text-sm font-semibold"><?php echo ($floorplan_item['max_beds'] > $floorplan_item['min_beds'] ) ? ($floorplan_item['min_bath'] . '<i class="text-[12px]">+</i>') : $floorplan_item['min_bath']; ?></span>
        ...
        <div class="border-b-[1px] border-simms-gold">
            <div class="px-3 pb-3 flex flex-row items-center gap-1.5">
                <div class="bg-primary-green text-white h-[28px] w-[28px] flex flex-col justify-center items-center">
                    <span class="block font-semibold p-1"><?php echo $homes_count; ?></span>
                </div>
        ...
        <?php else: ?>
            <!-- Placeholder div or similar for consistent layout -->
            <div class="px-3 pb-3 opacity-50">
                <span class="font-semibold text-lg block"></span>
            </div>
        <?php endif; ?>
    </div>
</article><?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/partials/content-communities.blade.php ENDPATH**/ ?>