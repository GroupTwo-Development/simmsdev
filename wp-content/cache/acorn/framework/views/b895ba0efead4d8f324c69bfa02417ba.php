...
<section id="elevations" class="relative object-cover mt-1 w-full" style="background-image: url('<?= \Roots\asset('assets/pattern2.png'); ?>')">
    <div class="container mx-auto ">
        ...
        <div class="flex flex-col justify-center items-center content-center  py-16 lg:py-16 pt-10">
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 md:gap-2 py-3">
                <?php $__currentLoopData = $plans_items['elevation_photos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elevation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/partials/plans/elevation.blade.php ENDPATH**/ ?>