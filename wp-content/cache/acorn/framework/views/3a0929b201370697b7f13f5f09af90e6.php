<?php if($homes_items['description']): ?>
       ...
       <div class="bg-primary-green relative pt-14 xl:pt-20 pb-28 lg:pb-40 overflow-hidden">
            <div class="container mx-auto">
                <div class="text-white text-center xl:max-w-screen-lg mx-auto">
                    <?php if($homes_items['headline']): ?>
                        <h2 class="font-arno_pro_subhead font-normal text-3xl md:text-4xl mb-5"><?php echo e($homes_items['headline']); ?></h2>
                    <?php endif; ?>
                    <?php if($homes_items['description']): ?>
                        <div>
                            <?php echo $homes_items['description']; ?>
...
<?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/partials/homes/description.blade.php ENDPATH**/ ?>