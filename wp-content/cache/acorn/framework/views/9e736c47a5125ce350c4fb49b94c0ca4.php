                    ...
                    <?php $__currentLoopData = $associated_homes['homes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $home): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <article class="group flex flex-col overflow-hidden bg-white shadow-md mb-8 w-full md:w-[49%] lg:w-[32%] <?php echo e($index >= 3 ? ' hidden' : ''); ?>">
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <?php if($home['assigned_community']): ?>
                                    <div class="border-b-[1px] border-simms-gold">
                                        <div class="px-3 pb-3 flex flex-row items-center gap-1 text-left">
                                            ...
                                            <span class="text-sm font-semibold capitalize block">
                                                <a href="<?php echo e($home['assigned_plan_permalink']); ?>" class="hover:text-simms-gold"><?php echo e($home['assigned_community']->post_title); ?></a>
                                            </span>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php endif; ?><?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/partials/plans/associated_homes.blade.php ENDPATH**/ ?>