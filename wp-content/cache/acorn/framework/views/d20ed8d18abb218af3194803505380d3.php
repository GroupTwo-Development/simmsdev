...
<?php $component->withAttributes(['href' => ''.e($communities_items['sitemap_url']).'','class' => 'text-secondary-green border-b-secondary-green mt-3 md:mt-5 hover:text-simms-gold transition-all ease-in-out']); ?><?php echo e(__('
  View Interactive Plans')); ?> <?php echo $__env->renderComponent(); ?>
