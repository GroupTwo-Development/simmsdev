...
<?php if($homes_items['virtual_tour']): ?>
              ...
              <div class="py-16 lg:py-16 xl:py-28 flex flex-col justify-center items-center content-center w-full text-center">
                ...
                <div class="py-3 group lg:flex lg:flex-row lg:justify-center items-center w-full lg:space-x-6">
                  <div class="h-[340px] w-full md:h-[400px] lg:h-[450px]">
                    <iframe src="<?php echo e($homes_items['virtual_tour']); ?>" width="100%" height="100%"></iframe>
                  </div>
                </div>
              </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/partials/homes/virtual-tour.blade.php ENDPATH**/ ?>