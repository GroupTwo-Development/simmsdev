  ...
  <div class="mt-10">
    <div class="container mx-auto">
      <div class=" text-white pb-5 flex flex-col justify-center items-center lg:flex lg:flex-row lg:justify-between w-full lg:content-center">
          <div>
            <p class="text-[13px]">©<?php echo e(Date('Y')); ?> Charles Simms Development. All Rights Reserved | <a href="/privacy-policy">Privacy Policy</a> | <a href="/grouptwo.com" target="_blank">Site by GroupTwo</a></p>
          </div>
