...
<?php $component->withAttributes([]); ?>
         ...
         <?php $__env->slot('bg_image', null, []); ?> 
            ...
            ?>
            <img src="<?= \Roots\asset('assets/AboutUs-HeaderImage.jpg'); ?>" alt="">        
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <div>
        <?php while(have_posts()): ?> <?php (the_post()); ?>
            <?php echo $__env->make('partials.content-about', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endwhile; ?>
    </div>
...
<?php echo $__env->make('layouts.primary-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/grouptwodev/Herd/simmsdev-app/wp-content/themes/simmsdev/resources/views/page-about.blade.php ENDPATH**/ ?>